...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/dabba-nation', {
...
const sellersData = [
  ...
  },
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1568901346375-23c44588b664?w=800&h=400&fit=crop',
    address: {
